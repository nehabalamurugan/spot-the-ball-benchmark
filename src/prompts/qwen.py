...
def extract_qwen_response(response):
    """Extract the generated assistant text from Qwen output format."""
    if (
...
def query_model(pipe, image_path: str, text_prompt: str, max_tokens: int = 300):
    ...
    try:
        ...
        return extract_qwen_response(response)
    except Exception as e:
